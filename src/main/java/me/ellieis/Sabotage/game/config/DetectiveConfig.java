...
public record DetectiveConfig(int innocentKarmaPenalty, int detectiveKarmaPenalty, int saboteurKarmaAward, boolean forceDetective){
    public static final Codec<DetectiveConfig> CODEC = RecordCodecBuilder.create(instance ->
            instance.group(
                    ...
                    Codec.BOOL.optionalFieldOf("force_detective", false).forGetter(DetectiveConfig::forceDetective)
